...
export default function Footer() {
    return (
        <footer className="bg-zinc-900 border-t border-zinc-800 text-zinc-300 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    
                    {/* Brand Section */}
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-4 tracking-tight">ShopBrand.</h2>
                        <p className="text-zinc-400 mb-6 leading-relaxed">
                            Your one-stop destination for the latest trends, electronics, and daily essentials. Delivered fast, to your doorstep.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 whitespace-nowrap">
                            ...
                            <li><Link to="#" className="hover:text-white transition-colors duration-200">Featured Items</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 whitespace-nowrap">
                            ...
                            <li><Link to="#" className="hover:text-white transition-colors duration-200">FAQ & Help</Link></li>
                            <li><Link to="#" className="hover:text-white transition-colors duration-200">Returns & Exchanges</Link></li>
                            <li><Link to="/store-registration" className="hover:text-white transition-colors duration-200">Become a Vendor</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm mb-4">Subscribe to our newsletter to get 10% off your first order.</p>
                        <form className="flex">
                            <input 
                                type="email" 
                                placeholder="Enter your email" 
                                className="bg-zinc-800 text-white px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-1 focus:ring-emerald-500 border border-zinc-700 focus:border-emerald-500"
                                required
                            />
                            <button 
                                type="submit" 
                                className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-r-md transition-colors duration-200 font-medium whitespace-nowrap"
                            >
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-zinc-500">
                    <p className="mb-4 md:mb-0">&copy; {new Date().getFullYear()} ShopBrand Inc. All rights reserved.</p>
